...
const MaintenancePortal = () => {
  ...
  return (
    <m.div 
      className="glass-panel" id="maintenance"
      initial={{ opacity: 0, y: 100 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true, margin: "-50px" }}
      transition={{ duration: 1.2, type: "spring", bounce: 0.3 }}
    >
      <h2><Wrench className="inline-icon" /> Maintenance Request</h2>
      <p style={{ textAlign: 'center', marginBottom: '30px', color: 'var(--text-secondary)' }}>
        Report electrical issues around the campus. Our club members will review and assist in repairs.
      </p>
